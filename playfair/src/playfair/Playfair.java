...
public class Playfair {
  public static char arr[][] = new char[5][5];
    ...
    public static String encryptString(String plain_text,String key1)
    {
        ...
        {
          if(str1.charAt(str1.length()-1)==plain_text.charAt(i)&& f==0)
          {
            str1.append('x');
       ...
       // System.out.print("\nrefer:"+str1);
        ...
        for(int i=0;i<new_text.length();i+=2) //first two letters taken and chek has interation etc,..
        {
          int x1 = rowMap.get(new_text.charAt(i));
         // System.out.println("vweid"+new_text.charAt(i));
    ...
    public static void main(String[] args) {
		...
		String encrypted = encryptString(plain_text,key);
                ...
                System.out.print("Plain Text  After Decrpytion : ");
